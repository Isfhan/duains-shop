...
/**
 * Duains storefront — catalog tree override
 * ------------------------------------------
 * Same structure and class names as the ai-client-html original so the
 * core catalog-filter.js / zeynep logic keeps running unchanged. Adds a
 * utility footer (basket with live count + account) inside the off-canvas
 * drawer so the mobile navigation needs no intermediate panel.
 *
